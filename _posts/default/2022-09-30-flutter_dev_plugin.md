...
또한 Microsoft는 Flutter 앱에서 사용할 수 있도록 수천 개의 Fluent 아이콘을 fluentui_system_icons 패키지를 통해 제공합니다. 마지막으로 bitsdogo_window 패키지는 제목 표시줄을 지원하고 있어 제목 표시줄을 바꾸는데 용이 합니다.   

> [훌륭한 데스크탑 패키지 및 프로젝트들 (Github)](https://github.com/leanflutter/awesome-flutter-desktop){:target="_blank"}  
